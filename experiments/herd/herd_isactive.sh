...
for workers in 1 2 3 4 5 6 ; do
	...
	sleep 3
        ...
        ssh -o LogLevel=QUIET -t $(machine2ssh machine4) "$ROOT_DIR/ukharon_experiment/$(machine2dir machine1)/deployment/workers-stop.sh"
        ssh -o LogLevel=QUIET -t $(machine2ssh machine4) "$ROOT_DIR/ukharon_experiment/$(machine2dir machine1)/deployment/controller-stop.sh"
