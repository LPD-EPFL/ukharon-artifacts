...
We do not provide the scripts the generate the figures themselves.
...
This section will guide you on how to build, configure, and run all experiments to reproduce the results presented in the paper from scratch.
...
The artifcats can either be built on your own deployment machine or directly on the provided cluster. The latter already meets all dependencies and lets you jump to [the next section](#building-the-artifacts)
